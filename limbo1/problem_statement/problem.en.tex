...
\section*{Input}
The first and only line of input consists of 2 numbers, $R$ and $D$ ($1 \leq R, D \leq 10^{9} - 1$), specifying how far right and down the target dream is.

\section*{Output}
Output the factor by which time slows down in the target dream.